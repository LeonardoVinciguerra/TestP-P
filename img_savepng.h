 ...
 */
#ifndef __IMG_SAVEPNG_H__
#define __IMG_SAVEPNG_H__
 ...
 */
DECLSPEC int SDLCALL IMG_SavePNG( const char *file, SDL_Surface *surf, int compression = -1 );
/**
 * Takes a SDL_RWops pointer, a surface to save, and a compression level.
 * compression can be 0(min) through 9(max), or -1(default).
 */
DECLSPEC int SDLCALL IMG_SavePNG_RW( SDL_RWops *src, SDL_Surface *surf, int compression = -1 );
